...
key <- "wvIyhlT8H6662F0w3tJbOo5hW"
secret <- "f0bQfKbFazaof43hplw67uHJ3pK1aVDwTc2EDvcKBybfqGcVk0"
token <- "1043285396514328577-hdh0jOj3QgzVKgvknhL3hK9GAFpMHJ"
tokensecret <- "og5BjA4vrCibN6TcpDMhAkJ9gSDKsJBFQ8qDXcAIJD86U"

# Autenticação.
setup_twitter_oauth(consumer_key = key, consumer_secret = secret, access_token = token, access_secret = tokensecret)
