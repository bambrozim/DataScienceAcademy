...
# Coletando a url do filme: 13 Horas - Os Soldados Ocultos
?read_html
...
# Extraindo a tag 'table' do código HTML e convertendo para data frame
...
# Removendo as duas primeiras linhas e adicionando nome as colunas
tab <- tab[-(1:2), ]
head(tab)
...
tab <- separate(tab, result, c('winner', 'loser', sep = ', '))
head(tab)
